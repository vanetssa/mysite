    ...
    function html5Upload() {	
    	...
    	sUploadURL= 'http://www.tourtips.com/module/smart_editor/quick_photo_uploader/popup/FileUploader_html5.php'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : 'http://www.tourtips.com/module/smart_editor/quick_photo_uploader/popup/FileUploader.php',	//샘플 URL입니다.
